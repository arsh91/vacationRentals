...
if(isset($_POST['submit'])){
    ...
    if($_POST['background']=="Y"){
        $background= "Y";
    }else{
        $background= "N";
    }
    if($_POST['smartphone']=="Y"){
        $smartphone= "Y";
    }else{
        $smartphone= "N";
    }
    if($_POST['transportation']=="Y"){
        $transportation= "Y";
    }else{
        $transportation= "N";
    }
    if($_POST['customers']=="Y"){
        $customers= "Y";
    }else{
        $customers= "N";
    }
    $checkbox1= $_POST['checkbox_Mon_9AM_6PM'];
    $checkbox2= $_POST['checkbox_Mon_6PM_10PM'];
    $checkbox3= $_POST['checkbox_Tues_9AM_6PM'];
    $checkbox4= $_POST['checkbox_Tues_6PM_10PM'];
    $checkbox5= $_POST['checkbox_Wed_9AM_6PM'];
    $checkbox6= $_POST['checkbox_Wed_6PM_10PM'];
    $checkbox7= $_POST['checkbox_Thurs_9AM_6PM'];
    $checkbox8= $_POST['checkbox_Thurs_6PM_10PM'];
    $checkbox9= $_POST['checkbox_Fri_9AM_6PM'];
    $checkbox10= $_POST['checkbox_Fri_6PM_10PM'];
    $checkbox11= $_POST['checkbox_Sat_9AM_6PM'];
    $checkbox12= $_POST['checkbox_Sat_6PM_10PM'];
    $checkbox13= $_POST['checkbox_Sun_9AM_6PM'];
    $checkbox14= $_POST['checkbox_Sun_6PM_10PM'];
...
<?php
    ...
    $bodytext ='<div><p>First Name = '.$firstname.' </p><p> Last Name = '.$lastname.' </p><p> Address = '.$address.' </p><p> City = '.$city.' </p> <p>  State = '.$state.' </p> <p> Zip = '.$Zip.' </p><p> Cell = '.$phone.' </p><p> Email = '.$email.' </p><p>  Background = '.$background.' </p><p> Smartphone  = '.$smartphone.' </p><p> Transportation = '.$transportation.' </p><p> Customers = '.$customers.' </p><p>  Monday 9 AM - 6 PM = '.$checkbox1.' </p><p>  Monday 6 PM - 10 PM = '.$checkbox2.' </p><p>  Tuesday 9 AM - 6 PM = '.$checkbox3.' </p><p>  Tuesday 6 PM - 10 PM = '.$checkbox4.' </p><p>  Wednesday 9 AM - 6 PM = '.$checkbox5.' </p><p>  Wednesday 6 PM - 10 PM = '.$checkbox6.' </p><p>  Thursday 9 AM - 6 PM = '.$checkbox7.' </p><p>  Thursday 6 PM - 10 PM = '.$checkbox8.' </p><p>  Friday 9 AM - 6 PM = '.$checkbox9.' </p><p>  Friday 6 PM - 10 PM = '.$checkbox10.' </p><p>  Saturday 9 AM - 6 PM   = '.$checkbox11.' </p><p>  Saturday 6 PM - 10 PM = '.$checkbox12.' </p><p>  Saturday 6 PM - 10 PM = '.$checkbox13.' </p><p>  Sunday 6 PM - 10 PM = '.$checkbox14.' </p><p>  AdditionalInfo	 = '.$additionalInfo.' </p></div>';
    print_r($bodytext);
